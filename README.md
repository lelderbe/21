...
За основу я брал алгоритм сортировки вставками (insertion sort). Идея: перебирать элементы и вставлять в нужное место в результирующем стеке. В итоге появился такой план действий:
<details>
