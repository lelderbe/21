...
## Philosophers
    ...
    Цель проекта: научиться работать из нескольких параллельных потоков (философы)
    с общими разделяемыми ресурсами (вилки, печать)
...
Чтобы проект стал немного понятнее, расскажу про свой путь)
