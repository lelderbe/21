...
За основу я брал алгоритм сортировки вставками (insertion sort). Идея: перебирать элементы и вставлять в нужное место в результирующем стеке. Я люблю, когда просто. В итоге появился такой план действий:
<details>
